        ...
        <div class="col-xl-6">
            ...
            @if(Session::has('failed'))
                ...
                <table class="text-left w-full border-collapse">
                    ...
                    <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light"> Password </th>
                    ...
                    @if(count($users) > 0)
                        @foreach($users as $user)
                            <tr class="hover:bg-grey-lighter">
                                ...
                                <td class="py-4 px-6 border-b border-grey-light"> {{$user->password}} </td>
                                    ...
                                    @if(Route::has('login'))
                                        @auth
                                            <form action="{{route('users.destroy', $user->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{route('users.show', $user->id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded" style="margin-left: 5px;"> View </a>
                                                <a href="{{route('users.edit', $user->id)}}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 border border-yellow-500 rounded"style="margin-left: 5px;"> Edit </a>
